...
let age = companies.filter(item => item.start >= 1980 && item.end < 1990)
console.log(age)
...
let tekDize = companies.map(item =>{
 ...
 let toplam = companies.reduce((total,item) => total+(item.end-item.start ),0)
